...
- [x] 2.3 Sanity-check the rest of the `Push tag` step is unchanged: same trigger, version-gate, existing-tag guard, and annotated `git tag -a ... -m "chore(release): ..."` message.
