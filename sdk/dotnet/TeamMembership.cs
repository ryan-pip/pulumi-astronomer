...
namespace RyanPip.Astronomer
{
    ...
    /// </summary>
    [AstronomerResourceType("astronomer:index/teamMembership:TeamMembership")]
    public partial class TeamMembership : global::Pulumi.CustomResource
    {
        ...
        public TeamMembership(string name, TeamMembershipArgs args, CustomResourceOptions? options = null)
            : base("astronomer:index/teamMembership:TeamMembership", name, args ?? new TeamMembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TeamMembership(string name, Input<string> id, TeamMembershipState? state = null, CustomResourceOptions? options = null)
            : base("astronomer:index/teamMembership:TeamMembership", name, state, MakeResourceOptions(options, id))
        {
        }
