...
namespace RyanPip.Astronomer
{
    ...
    public partial class TeamRoles : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("dagRoles")]
        public Output<ImmutableArray<Outputs.TeamRolesDagRole>> DagRoles { get; private set; } = null!;
    ...
    {
        [Input("dagRoles")]
        private InputList<Inputs.TeamRolesDagRoleArgs>? _dagRoles;

        /// <summary>
        /// The DAG roles to assign to the team. Each role grants permissions to a specific DAG or DAGs with a specific tag within a deployment. Each deployment referenced in `DagRoles` must also have a corresponding entry in `DeploymentRoles` (e.g. with `DEPLOYMENT_ACCESSOR` role).
        /// </summary>
        public InputList<Inputs.TeamRolesDagRoleArgs> DagRoles
        {
            get => _dagRoles ?? (_dagRoles = new InputList<Inputs.TeamRolesDagRoleArgs>());
            set => _dagRoles = value;
        }
    ...
    {
        [Input("dagRoles")]
        private InputList<Inputs.TeamRolesDagRoleGetArgs>? _dagRoles;

        /// <summary>
        /// The DAG roles to assign to the team. Each role grants permissions to a specific DAG or DAGs with a specific tag within a deployment. Each deployment referenced in `DagRoles` must also have a corresponding entry in `DeploymentRoles` (e.g. with `DEPLOYMENT_ACCESSOR` role).
        /// </summary>
        public InputList<Inputs.TeamRolesDagRoleGetArgs> DagRoles
        {
            get => _dagRoles ?? (_dagRoles = new InputList<Inputs.TeamRolesDagRoleGetArgs>());
            set => _dagRoles = value;
        }
