...
namespace RyanPip.Astronomer
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("RyanPip.Astronomer.version.txt");
    ...
    internal sealed class AstronomerResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AstronomerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
