...
//			exampleTeams, err := astronomer.GetTeams(ctx, &astronomer.GetTeamsArgs{}, nil)
//			if err != nil {
//				return err
//			}
...
//				return err
//			}
//			ctx.Export("exampleTeams", exampleTeams)
//			return nil
//		})
//	}
//
...
func GetTeamsOutput(ctx *pulumi.Context, args GetTeamsOutputArgs, opts ...pulumi.InvokeOption) GetTeamsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetTeamsResultOutput, error) {
			...
			return ctx.InvokeOutput("astronomer:index/getTeams:getTeams", args, GetTeamsResultOutput{}, options).(GetTeamsResultOutput), nil
