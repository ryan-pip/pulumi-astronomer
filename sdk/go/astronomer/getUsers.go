...
//			exampleUsers, err := astronomer.GetUsers(ctx, &astronomer.GetUsersArgs{}, nil)
//			if err != nil {
//				return err
//			}
...
//				return err
//			}
//			ctx.Export("exampleUsers", exampleUsers)
//			return nil
//		})
//	}
//
...
func GetUsersOutput(ctx *pulumi.Context, args GetUsersOutputArgs, opts ...pulumi.InvokeOption) GetUsersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetUsersResultOutput, error) {
			...
			return ctx.InvokeOutput("astronomer:index/getUsers:getUsers", args, GetUsersResultOutput{}, options).(GetUsersResultOutput), nil
