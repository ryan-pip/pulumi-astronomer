...
//			exampleWorkspaces, err := astronomer.GetWorkspaces(ctx, &astronomer.GetWorkspacesArgs{}, nil)
//			if err != nil {
//				return err
//			}
...
//				return err
//			}
//			ctx.Export("exampleWorkspaces", exampleWorkspaces)
//			return nil
//		})
//	}
//
...
func GetWorkspacesOutput(ctx *pulumi.Context, args GetWorkspacesOutputArgs, opts ...pulumi.InvokeOption) GetWorkspacesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetWorkspacesResultOutput, error) {
			...
			return ctx.InvokeOutput("astronomer:index/getWorkspaces:getWorkspaces", args, GetWorkspacesResultOutput{}, options).(GetWorkspacesResultOutput), nil
