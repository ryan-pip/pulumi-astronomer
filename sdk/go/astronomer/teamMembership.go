...
// Manages a single user's membership in an Astro team. Use this resource instead of the `memberIds` attribute on `Team` when you need to manage memberships independently or across multiple state files.
//
...
func NewTeamMembership(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("astronomer:index/teamMembership:TeamMembership", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTeamMembership(ctx *pulumi.Context,
	...
	var resource TeamMembership
	err := ctx.ReadResource("astronomer:index/teamMembership:TeamMembership", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
