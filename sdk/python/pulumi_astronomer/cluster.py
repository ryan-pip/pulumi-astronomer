...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 vpc_subnet_range: pulumi.Input[builtins.str],
                 workspace_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 pod_subnet_range: Optional[pulumi.Input[builtins.str]] = None,
                 service_peering_range: Optional[pulumi.Input[builtins.str]] = None,
                 service_subnet_range: Optional[pulumi.Input[builtins.str]] = None,
                 timeouts: Optional[pulumi.Input['ClusterTimeoutsArgs']] = None):
        """
        The set of arguments for constructing a Cluster resource.
        :param pulumi.Input[builtins.str] cloud_provider: Cluster cloud provider - if changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] region: Cluster region - if changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] type: Cluster type
        :param pulumi.Input[builtins.str] vpc_subnet_range: Cluster VPC subnet range. If changed, the cluster will be recreated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] workspace_ids: Cluster workspace IDs
        :param pulumi.Input[builtins.str] name: Cluster name
        :param pulumi.Input[builtins.str] pod_subnet_range: Cluster pod subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] service_peering_range: Cluster service peering range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] service_subnet_range: Cluster service subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        """
    ...
    def vpc_subnet_range(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpc_subnet_range(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vpc_subnet_range", value)

    @property
    @pulumi.getter(name="workspaceIds")
    def workspace_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def workspace_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def pod_subnet_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pod_subnet_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pod_subnet_range", value)

    @property
    @pulumi.getter(name="servicePeeringRange")
    def service_peering_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_peering_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_peering_range", value)

    @property
    @pulumi.getter(name="serviceSubnetRange")
    def service_subnet_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_subnet_range(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 is_limited: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 pod_subnet_range: Optional[pulumi.Input[builtins.str]] = None,
                 provider_account: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vpc_subnet_range: Optional[pulumi.Input[builtins.str]] = None,
                 workspace_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering Cluster resources.
        :param pulumi.Input[builtins.str] cloud_provider: Cluster cloud provider - if changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] created_at: Cluster creation timestamp
        :param pulumi.Input[builtins.str] db_instance_type: Cluster database instance type
        :param pulumi.Input['ClusterHealthStatusArgs'] health_status: Cluster health status
        :param pulumi.Input[builtins.bool] is_limited: Whether the cluster is limited
        ...
        :param pulumi.Input[builtins.str] pod_subnet_range: Cluster pod subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] provider_account: Cluster provider account
        :param pulumi.Input[builtins.str] region: Cluster region - if changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] service_peering_range: Cluster service peering range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] service_subnet_range: Cluster service subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        :param pulumi.Input[builtins.str] status: Cluster status
        :param pulumi.Input[builtins.str] tenant_id: Cluster tenant ID
        :param pulumi.Input[builtins.str] type: Cluster type
        :param pulumi.Input[builtins.str] updated_at: Cluster last updated timestamp
        :param pulumi.Input[builtins.str] vpc_subnet_range: Cluster VPC subnet range. If changed, the cluster will be recreated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] workspace_ids: Cluster workspace IDs
        """
    ...
    def is_limited(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_limited.setter
    def is_limited(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def provider_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_account(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="vpcSubnetRange")
    def vpc_subnet_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cluster VPC subnet range. If changed, the cluster will be recreated.
        """
        return pulumi.get(self, "vpc_subnet_range")
    ...
    @vpc_subnet_range.setter
    def vpc_subnet_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_subnet_range", value)

    @property
    @pulumi.getter(name="workspaceIds")
    def workspace_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Cluster workspace IDs
        """
        return pulumi.get(self, "workspace_ids")
    ...
    @workspace_ids.setter
    def workspace_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "workspace_ids", value)


class Cluster(pulumi.CustomResource):

    pulumi_type = "astronomer:index/cluster:Cluster"
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            vpc_subnet_range: Optional[pulumi.Input[builtins.str]] = None,
            workspace_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="isLimited")
    def is_limited(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the cluster is limited
        """
        return pulumi.get(self, "is_limited")
    ...
    @property
    @pulumi.getter(name="podSubnetRange")
    def pod_subnet_range(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cluster pod subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        """
        return pulumi.get(self, "pod_subnet_range")
    ...
    @property
    @pulumi.getter(name="providerAccount")
    def provider_account(self) -> pulumi.Output[builtins.str]:
        """
        Cluster provider account
        """
        return pulumi.get(self, "provider_account")
    ...
    @property
    @pulumi.getter(name="servicePeeringRange")
    def service_peering_range(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cluster service peering range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        """
        return pulumi.get(self, "service_peering_range")
    ...
    @property
    @pulumi.getter(name="serviceSubnetRange")
    def service_subnet_range(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cluster service subnet range - required for 'GCP' clusters. If changed, the cluster will be recreated.
        """
        return pulumi.get(self, "service_subnet_range")
    ...
    @property
    @pulumi.getter(name="vpcSubnetRange")
    def vpc_subnet_range(self) -> pulumi.Output[builtins.str]:
        """
        Cluster VPC subnet range. If changed, the cluster will be recreated.
        """
        return pulumi.get(self, "vpc_subnet_range")
    ...
    @property
    @pulumi.getter(name="workspaceIds")
    def workspace_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Cluster workspace IDs
        """
        return pulumi.get(self, "workspace_ids")
