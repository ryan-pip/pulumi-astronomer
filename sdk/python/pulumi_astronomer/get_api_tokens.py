...
class GetApiTokensResult:
    ...
    def include_only_organization_tokens(self) -> Optional[builtins.bool]:
...
def get_api_tokens(deployment_id: Optional[builtins.str] = None,
                   include_only_organization_tokens: Optional[builtins.bool] = None,
...
def get_api_tokens_output(deployment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          include_only_organization_tokens: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
