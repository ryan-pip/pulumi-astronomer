...
def get_cluster_options(cloud_provider: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_provider: ClusterOptions cloud provider. Allowed values: `AWS`, `GCP`, `AZURE`.
    """
    __args__ = dict()
...
def get_cluster_options_output(cloud_provider: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('astronomer:index/getClusterOptions:getClusterOptions', __args__, opts=opts, typ=GetClusterOptionsResult)
