...
def get_cluster_options(cloud_provider: Optional[builtins.str] = None,
...
def get_cluster_options_output(cloud_provider: Optional[pulumi.Input[Optional[builtins.str]]] = None,
