...
class GetDeploymentOptionsResult:
    ...
    @property
    @pulumi.getter
    def executor(self) -> Optional[builtins.str]:
        """
        Executor
        """
    ...
    @property
    @pulumi.getter
    def executors(self) -> Sequence[builtins.str]:
        """
        Available executors
        """
...
def get_deployment_options(cloud_provider: Optional[builtins.str] = None,
                           deployment_id: Optional[builtins.str] = None,
                           deployment_type: Optional[builtins.str] = None,
                           executor: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_id: Deployment ID
    :param builtins.str deployment_type: Deployment type
    :param builtins.str executor: Executor
    """
    __args__ = dict()
...
def get_deployment_options_output(cloud_provider: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  executor: Optional[pulumi.Input[Optional[builtins.str]]] = None,
