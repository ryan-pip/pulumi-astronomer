...
class HybridClusterWorkspaceAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the hybrid cluster to set authorizations for
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] workspace_ids: The IDs of the workspaces to authorize for the hybrid cluster
        """
...
class HybridClusterWorkspaceAuthorization(pulumi.CustomResource):
    ...
    pulumi_type = "astronomer:index/hybridClusterWorkspaceAuthorization:HybridClusterWorkspaceAuthorization"
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            workspace_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'HybridClusterWorkspaceAuthorization':
        """
    ...
    @property
    @pulumi.getter(name="workspaceIds")
    def workspace_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the workspaces to authorize for the hybrid cluster
        """
        return pulumi.get(self, "workspace_ids")
