...
class HybridClusterWorkspaceAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_id: The ID of the hybrid cluster to set authorizations for
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] workspace_ids: The IDs of the workspaces to authorize for the hybrid cluster
        """
...
@pulumi.type_token("astronomer:index/hybridClusterWorkspaceAuthorization:HybridClusterWorkspaceAuthorization")
class HybridClusterWorkspaceAuthorization(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="workspaceIds")
    def workspace_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The IDs of the workspaces to authorize for the hybrid cluster
        """
        return pulumi.get(self, "workspace_ids")
