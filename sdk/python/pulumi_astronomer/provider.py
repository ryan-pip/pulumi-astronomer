...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization_id: Organization ID this provider will operate on.
        :param pulumi.Input[builtins.str] host: API host to use for the provider. Default is `https://api.astronomer.io`
        :param pulumi.Input[builtins.str] token: Astro API Token. Can be set with an `ASTRO_API_TOKEN` env var.
        """
...
class Provider(pulumi.ProviderResource):
    ...
    pulumi_type = "pulumi:providers:astronomer"
