...
class TeamArgs:
    def __init__(__self__, *,
                 organization_role: pulumi.Input[builtins.str],
                 deployment_roles: Optional[pulumi.Input[Sequence[pulumi.Input['TeamDeploymentRoleArgs']]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 member_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 workspace_roles: Optional[pulumi.Input[Sequence[pulumi.Input['TeamWorkspaceRoleArgs']]]] = None):
        """
        The set of arguments for constructing a Team resource.
        :param pulumi.Input[builtins.str] organization_role: The role to assign to the Organization
        :param pulumi.Input[Sequence[pulumi.Input['TeamDeploymentRoleArgs']]] deployment_roles: The roles to assign to the Deployments
        :param pulumi.Input[builtins.str] description: Team description
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] member_ids: The IDs of the users to add to the Team
    ...
    def organization_role(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def organization_role(self, value: pulumi.Input[builtins.str]):
    ...
    def member_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @member_ids.setter
    def member_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _TeamState:
    def __init__(__self__, *,
                 ...
                 deployment_roles: Optional[pulumi.Input[Sequence[pulumi.Input['TeamDeploymentRoleArgs']]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 is_idp_managed: Optional[pulumi.Input[builtins.bool]] = None,
                 member_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 organization_role: Optional[pulumi.Input[builtins.str]] = None,
                 roles_count: Optional[pulumi.Input[builtins.int]] = None,
                 updated_at: Optional[pulumi.Input[builtins.str]] = None,
                 updated_by: Optional[pulumi.Input['TeamUpdatedByArgs']] = None,
                 workspace_roles: Optional[pulumi.Input[Sequence[pulumi.Input['TeamWorkspaceRoleArgs']]]] = None):
        """
        Input properties used for looking up and filtering Team resources.
        :param pulumi.Input[builtins.str] created_at: Team creation timestamp
        :param pulumi.Input['TeamCreatedByArgs'] created_by: Team creator
        :param pulumi.Input[Sequence[pulumi.Input['TeamDeploymentRoleArgs']]] deployment_roles: The roles to assign to the Deployments
        :param pulumi.Input[builtins.str] description: Team description
        :param pulumi.Input[builtins.bool] is_idp_managed: Whether the Team is managed by an identity provider
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] member_ids: The IDs of the users to add to the Team
        :param pulumi.Input[builtins.str] name: Team name
        :param pulumi.Input[builtins.str] organization_role: The role to assign to the Organization
        :param pulumi.Input[builtins.int] roles_count: Number of roles assigned to the Team
        :param pulumi.Input[builtins.str] updated_at: Team last updated timestamp
    ...
    def is_idp_managed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_idp_managed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="organizationRole")
    def organization_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role to assign to the Organization
        """
        return pulumi.get(self, "organization_role")
    ...
    @organization_role.setter
    def organization_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "organization_role", value)

    @property
    @pulumi.getter(name="rolesCount")
    def roles_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @roles_count.setter
    def roles_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Team(pulumi.CustomResource):
    ...
    pulumi_type = "astronomer:index/team:Team"
    ...
    @property
    @pulumi.getter(name="isIdpManaged")
    def is_idp_managed(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the Team is managed by an identity provider
        """
        return pulumi.get(self, "is_idp_managed")
    ...
    @property
    @pulumi.getter(name="memberIds")
    def member_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the users to add to the Team
        """
        return pulumi.get(self, "member_ids")
    ...
    @property
    @pulumi.getter(name="organizationRole")
    def organization_role(self) -> pulumi.Output[builtins.str]:
        """
        The role to assign to the Organization
        """
        return pulumi.get(self, "organization_role")
    ...
    @property
    @pulumi.getter(name="rolesCount")
    def roles_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of roles assigned to the Team
        """
        return pulumi.get(self, "roles_count")
