...
class UserInviteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] email: The email address of the user being invited
        :param pulumi.Input[builtins.str] role: The Organization role to assign to the user
        """
...
class _UserInviteState:
    def __init__(__self__, *,
                 ...
                 invite_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] email: The email address of the user being invited
        :param pulumi.Input[builtins.str] expires_at: The expiration date of the invite
        :param pulumi.Input[builtins.str] invite_id: The ID of the invite
    ...
    def invite_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @invite_id.setter
    def invite_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserInvite(pulumi.CustomResource):
    ...
    pulumi_type = "astronomer:index/userInvite:UserInvite"
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserInvite':
        """
    ...
    @property
    @pulumi.getter(name="inviteId")
    def invite_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the invite
        """
        return pulumi.get(self, "invite_id")
