...
class UserInviteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: The email address of the user being invited
        :param pulumi.Input[_builtins.str] role: The Organization role to assign to the user
        """
...
class _UserInviteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: The email address of the user being invited
        :param pulumi.Input[_builtins.str] expires_at: The expiration date of the invite
        :param pulumi.Input[_builtins.str] invite_id: The ID of the invite
...
@pulumi.type_token("astronomer:index/userInvite:UserInvite")
class UserInvite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user_invite = astronomer.UserInvite("user_invite",
    ...
    @_builtins.property
    @pulumi.getter(name="inviteId")
    def invite_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the invite
        """
        return pulumi.get(self, "invite_id")
